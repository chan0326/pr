...
-- values (1, 'Clarinda', 'Boilermaker1!', 'Chrissie', '230-644-4753', 'Professor', 0, 0, now(), now(),'qkrdydcksz48@gmail.com');
-- insert into users (id, username, password, name, phone, job, subscribe, point, reg_date, mod_date , email)
