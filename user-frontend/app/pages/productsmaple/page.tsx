...
export default function Payment({ params }: any) {
    ...
    return(<div className="w-[1920px] h-[2000px] relative overflow-hidden bg-white">
    <div className="flex flex-col justify-start items-start w-[421px] h-[493px] absolute left-[795px] top-[1074px] gap-8">
      <p className="flex-grow-0 flex-shrink-0 w-[1259px] h-[106px] text-[64px] font-semibold text-left text-black">
        point 결제{" "}
      </p>
      <input 
  type="number" 
...
/>
      <div
        className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[308px] relative gap-2 px-6 py-3.5 rounded-lg bg-black"
      ...
      <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 w-[421px] h-11 gap-6" />
    </div>
    <p className="w-[373px] absolute left-[885px] top-[420px] text-[40px] font-semibold text-left text-black">
      product
    </p>
    <div className="flex justify-start items-start absolute left-80 top-[527px] gap-8">
      <div
      ...
      >
        <div className="flex flex-col justify-end items-start flex-grow-0 flex-shrink-0 gap-3">
    ...
    <div className="flex flex-col justify-start items-center w-[1122.67px] absolute left-[398.67px] top-[244px] gap-6">
      <p className="self-stretch flex-grow-0 flex-shrink-0 w-[1122.67px] text-[64px] font-bold text-center text-black">
        Payment page{" "}
      </p>
    </div>
    <div className="w-[1920px] h-[264px] absolute left-0 top-[1736px] overflow-hidden bg-white">
